...
def generar_numeros_aleatorios():
    ...
    tk.messagebox.showinfo("Exito", "Los números se han generado y almacenado en el archivo")
...
# Crear etiqueta
etiqueta = tk.Label(ventana, text="Generador de Números", font=("Comic Sans MS", 22), bg="white", fg="black")
etiqueta.pack()
